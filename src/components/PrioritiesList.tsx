    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0 cursor-pointer" onClick={() => onSchoolClick(school)}>
          <h3 className="font-semibold text-foreground truncate mb-1">{school.name}</h3>
          <div className="flex items-center gap-2 mb-2">
            <p className="text-sm text-muted-foreground">{school.neighborhood}</p>
          ...
          <div className="flex flex-wrap gap-1.5">
            {isCampaignActive && school.vacancies && school.vacancies > 0 && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xs rounded border border-purple-200 dark:border-purple-800 font-semibold whitespace-nowrap bg-lime-500 text-lime-50">
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-semibold text-foreground mb-2">Nenhuma escola favorita</h2>
          <p className="text-muted-foreground">
            Volte para o mapa e favorite as escolas que você tem interesse. Depois você poderá organizá-las aqui por
            ordem de prioridade.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-4 p-4 bg-primary/5 rounded-lg border border-primary/20">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground">Dica:</strong> Arraste as escolas para organizá-las em ordem de
            prioridade. Suas preferências são salvas automaticamente neste dispositivo.
          </p>
        </div>
